        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    {{-- <div class="card-body">
                        <p class="card-text">Use <code class="highlighter-rouge">.table-striped</code> to add zebra-striping
                            to any
                            table row within the <code class="highlighter-rouge">&lt;tbody&gt;</code>. This styling doesn't
                            work in IE8
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-bold-500">Banjir</td>
                                    <td>Kecamatan Laweyan, Kecamatan Jebres</td>
                                    <td class="text-bold-500">12-12-2021</td>
                                    <td>12-12-2021</td>
                                    <td>
                                ...
                                <tr>
                                    <td class="text-bold-500">Kebakaran</td>
                                    <td>Kecamatan Laweyan, Kecamatan Jebres</td>
                                    <td class="text-bold-500">12-12-2021</td>
                                    <td>12-12-2021</td>
                                ...
                                <tr>
                                    <td class="text-bold-500">Tanah Longsor</td>
                                    <td>Kecamatan Laweyan, Kecamatan Jebres</td>
                                    <td class="text-bold-500">12-12-2021</td>
                                    <td>12-12-2021</td>
                                    <td><a href="#"><i class="badge-circle badge-circle-light-secondary font-medium-1"
                                ...
                                <tr>
                                    <td class="text-bold-500">Tsunami</td>
                                    <td>Kecamatan Laweyan, Kecamatan Jebres</td>
                                    <td class="text-bold-500">12-12-2021</td>
                                    <td>12-12-2021</td>
                                    <td><a href="#"><i class="badge-circle badge-circle-light-secondary font-medium-1"
